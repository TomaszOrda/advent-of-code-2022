...
class Cave:
    def __init__(self, scan) -> None:
        ...
        self.top = 0
        self.right = max(x_coords + [500 + self.down]) + 1
        self.left = min(x_coords + [500 - self.down]) - 1
        ...
        for x in range(0, self.right - self.left + 3):
            self.cave[self.down-1, x] = "#"
